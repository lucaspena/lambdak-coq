...
Lemma t_update_eq : forall (A : Type) (m : total_map A) x v,
    (x !-> v ; m) x = v.
Proof.
  intros. unfold t_update. unfold eqb_string. destruct (string_dec x x).
...
Theorem t_update_neq : forall (A : Type) (m : total_map A) x1 x2 v,
    ...
    (x1 !-> v ; m) x2 = m x2.
Proof.
  intros. unfold t_update. unfold eqb_string. destruct (string_dec x1 x2).
...
Lemma t_update_shadow : forall (A : Type) (m : total_map A) x v1 v2,
    (x !-> v2 ; x !-> v1 ; m) = (x !-> v2 ; m).
Proof.
  intros. unfold t_update. unfold eqb_string. simpl. apply functional_extensionality_dep.
  intros. destruct (string_dec x x0); trivial.
Qed.
(** [] *)
...
Proof.
  intros. unfold eqb_string. destruct (string_dec x y); constructor; trivial.
Qed.
(** [] *)
...
Theorem t_update_same : forall (A : Type) (m : total_map A) x,
    (x !-> m x ; m) = m.
Proof.
  intros. unfold t_update. unfold eqb_string. apply functional_extensionality_dep.
  intros. destruct (string_dec x x0); subst; trivial.
Qed.
(** [] *)
...
Proof.
  intros. unfold t_update. unfold eqb_string. apply functional_extensionality_dep.
  intros. destruct (string_dec x1 x), (string_dec x2 x); subst; trivial. contradiction.
Qed.
(** [] *)
